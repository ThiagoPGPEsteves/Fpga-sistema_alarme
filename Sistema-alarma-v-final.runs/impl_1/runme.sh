...
HD_PWD='C:/Users/eletrica/Downloads/Sistema_alarme_v2/Sistema_alarme_v2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log top_alarme.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source top_alarme.tcl -notrace
