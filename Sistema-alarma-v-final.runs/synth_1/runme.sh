...
HD_PWD='C:/Users/eletrica/Downloads/Sistema_alarme_v2/Sistema_alarme_v2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_alarme.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_alarme.tcl
